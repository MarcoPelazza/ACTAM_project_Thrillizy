...
var containerWidth = document.getElementById('flute-container').offsetWidth;
var containerHeight = document.getElementById('flute-container').offsetHeight;
img.height = containerHeight * 0.8
flute.height = img.height;
flute.width = img.width;
//$(window).resize()
console.log(flute);
console.log(img);
flute.style.left = img.height/2
